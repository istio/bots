...
var _controlHtml = []byte(`<a href="/maintainers">
    <svg class="icon"><use xlink:href="/icons/icons.svg#left-arrow"/></svg>
    Org Maintainers
</a>
`)

func controlHtmlBytes() ([]byte, error) {
	return _controlHtml, nil
}

func controlHtml() (*asset, error) {
	bytes, err := controlHtmlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "control.html", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
                ...
                <div class="paths">
                    <div class="property-table">
                        ...
                        <div class="value header">
                            Last PR Submitted Affecting Each Path
                        </div>
...
var _userHtml = []byte(`<a href="{{ .User.UserLogin }}">
    <div class="user">
        <div class="name">
            <div class="fit">
                {{ if .User.Name }}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"control.html": &bintree{controlHtml, map[string]*bintree{}},
