...
func (a SlicePipelineImpl) Transform(func([]interface{}) (interface{}, error)) SlicePipeline {
	panic("implement me")
}

func (a SlicePipelineImpl) To(func([]interface{}) error) PipelineEnd {
	panic("implement me")
}

func (a SlicePipelineImpl) Go() chan []OutResult {
	panic("implement me")
}

func (sp SlicePipelineImpl) makeChild() SlicePipelineImpl {

}

func (sp *SlicePipelineImpl) Expand() ScalarPipeline {
	next := sp.makeChild()
...
func (a SlicePipelineImpl) OnError(func(error)) SlicePipeline {
	panic("implement me")
}

func (a SlicePipelineImpl) WithContext(ctx context.Context) SlicePipeline {
	panic("implement me")
}

func (a SlicePipelineImpl) WithBuffer(int) SlicePipeline {
	panic("implement me")
}

func (a SlicePipelineImpl) WithParallelism(int) SlicePipeline {
	panic("implement me")
}

func (a SlicePipelineImpl) TransformToScalar(func([]interface{}) (interface{}, error)) ScalarPipeline {
	panic("implement me")
}
