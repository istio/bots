...
import (
	...
	"istio.io/bots/policybot/pkg/milestonemaker"
	"istio.io/pkg/env"
	"istio.io/pkg/log"
)

func milestoneMakerCmd() *cobra.Command {
...
func runMilestoneMaker(a *config.Args) error {
	...
	h := milestonemaker.New(gc, a)
	return h.MakeConfiguredMilestones(context.Background())
}
