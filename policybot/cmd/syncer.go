...
func syncerCmd() *cobra.Command {
	...
	ca.StartupOptions.GitHubToken = env.RegisterStringVar("ZENHUB_TOKEN", ca.StartupOptions.ZenHubToken, zenhubToken).Get()
	...
	syncerCmd := &cobra.Command{
		Use:   "syncer",
		Short: "Run the policybot syncer",
